    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-sand-500">
          AI-powered Amazon listing optimization using your brand DNA.
        </p>
      </div>
      ...
      >
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-sand-400">
            Comma-separated keywords to weave into the listing naturally.
          </p>
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            placeholder="e.g. emphasize premium materials, mention free pump included"
          />
        </div>

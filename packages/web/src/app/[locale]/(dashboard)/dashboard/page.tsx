...
export default function DashboardPage() {
  ...
  const greeting = me?.user.displayName
    ? t("greetingNamed", {
        name: me.user.displayName.split(" ")[0] ?? me.user.displayName,
      })
    : t("greetingDefault");
    ...
    <div className="space-y-6 gs-fade-in">
      ...
      {me && usagePercent >= 90 && (
        ...
        >
          ...
          >
            {me.workspace.plan === "free" ? t("upgradePlan") : t("viewUsage")}
          </Link>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          description={
            me
              ? t("creditsPerMonth", { count: me.workspace.quotaLimit })
              : ""
          }
        />
        <StatCard
          ...
          description={t("productsOnboarded")}
        />
        <StatCard
          title={t("statBrands")}
          value={String(brands.length)}
          description={t("brandsConfigured")}
        />
        <StatCard
          title={t("statCredits")}
          ...
          description={
            me
              ? t("quotaUsed", {
                  used: me.workspace.quotaUsed,
                  limit: me.workspace.quotaLimit,
                })
              : t("monthlyQuota")
          }
            ...
            >
              ...
              <div>
                <p
                  ...
                  style={{ color: "var(--gs-text)" }}
                >
                  {t("imageJobs", { count: imageJobCount })}
                </p>
          ...
          {recentGens.map((gen) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  {gen.productName} —{" "}
                  {gen.type === "aplus" ? t("genAplus") : t("genListing")}
                </p>
                <p className="text-xs" style={{ color: "var(--gs-text-faint)" }}>

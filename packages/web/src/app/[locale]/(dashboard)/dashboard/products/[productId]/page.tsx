  ...
  return (
    <section className="space-y-4" id="colors">
      ...
      <p className="text-xs" style={{ color: "var(--gs-text-faint)" }}>
        Define colors for Hero variant generation. Each color can produce a
        same-scene variant when you activate Hero on an image in Results.
      </p>
      ...
      {colors.length === 0 && !showAdd && (
        ...
        >
          <p className="text-sm" style={{ color: "var(--gs-text-faint)" }}>
            No colors configured. Add colors to enable Hero variant generation.
          </p>
        </div>
      )}
    </section>

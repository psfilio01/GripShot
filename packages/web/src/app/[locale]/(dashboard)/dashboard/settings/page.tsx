...
export default function SettingsPage() {
  ...
  return (
    <div className="w-full max-w-none space-y-6 gs-fade-in">
      <div>
        <h1
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,22rem)_minmax(0,1fr)]">
        {/* Account */}
        <section className="gs-card-static p-6 flex h-full min-h-0 flex-col">
          <h2
          ...
          <div className="mt-4 space-y-3">
            <div className="flex items-center justify-between gap-3">
              <span className="text-sm shrink-0" style={{ color: "var(--gs-text-muted)" }}>
                Email
              </span>
              <span
                className="text-sm font-medium text-right truncate min-w-0"
        ...
        {/* Plan & Usage */}
        <section className="gs-card-static p-6 flex h-full min-h-0 min-w-0 flex-col">
        <h2
          className="text-base font-semibold"
          style={{ color: "var(--gs-text)" }}
        >

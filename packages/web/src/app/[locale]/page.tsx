...
const FEATURE_DEFS: { icon: string; span: string; titleKey: string; descKey: string }[] =
  [
    { icon: "camera", span: "col-span-1", titleKey: "f1t", descKey: "f1d" },
    { icon: "text", span: "col-span-1", titleKey: "f2t", descKey: "f2d" },
    { icon: "sparkle", span: "col-span-1", titleKey: "f3t", descKey: "f3d" },
    { icon: "dna", span: "col-span-1", titleKey: "f4t", descKey: "f4d" },
    { icon: "grid", span: "col-span-1", titleKey: "f5t", descKey: "f5d" },
    { icon: "credit", span: "col-span-1", titleKey: "f6t", descKey: "f6d" },
  ];

const STEP_DEFS: { num: string; titleKey: string; descKey: string }[] = [
  { num: "01", titleKey: "s1t", descKey: "s1d" },
  { num: "02", titleKey: "s2t", descKey: "s2d" },
  { num: "03", titleKey: "s3t", descKey: "s3d" },
];
...
const PLAN_DEFS: {
...
}[] = [
  {
    ...
    price: "€0",
    periodKey: "periodForever",
    featKeys: ["pf1", "pf2", "pf3", "pf4", "pf5"],
    ctaKey: "ctaFree",
    highlighted: false,
  },
  {
    planNameKey: "planStarter",
    price: "€29",
    periodKey: "periodMonth",
    featKeys: ["ps1", "ps2", "ps3", "ps4", "ps5", "ps6"],
    ctaKey: "ctaTrial",
    highlighted: true,
  },
  {
    ...
    price: "€79",
    periodKey: "periodMonth",
    featKeys: ["pp1", "pp2", "pp3", "pp4", "pp5", "pp6"],
    ctaKey: "ctaPro",
    highlighted: false,
  },
];
...
export default function LandingPage() {
  ...
  const otherLabel = locale === "en" ? t("langDe") : t("langEn");
    ...
    <div className="min-h-screen" style={{ background: "var(--gs-bg)" }}>
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/"
              locale={otherLocale}
              className="hidden sm:inline-block rounded-lg px-2.5 py-1 text-xs font-semibold uppercase tracking-wide"
              style={{
      ...
      >
        <div className="mx-auto flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-3 px-6">
          <StatBadge value={t("stat1v")} label={t("stat1l")} />
          <div
            className="hidden sm:block h-6 w-px"
            style={{ background: "var(--gs-border)" }}
          />
          <StatBadge value={t("stat2v")} label={t("stat2l")} />
          <div
            className="hidden sm:block h-6 w-px"
            style={{ background: "var(--gs-border)" }}
          />
          <StatBadge value={t("stat3v")} label={t("stat3l")} />
        </div>
      </section>
      ...
      <section id="features" className="mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {FEATURE_DEFS.map((f) => (
            <div key={f.titleKey} className={`gs-card p-6 ${f.span}`}>
              <div
